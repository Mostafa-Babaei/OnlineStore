    ...
    public class CategoryService : ICategoryService
    {
        ...
        public ApiResult EditCategory(EditCategoryDto model)
        {
            ...
            catch (Exception ex)
            {
                ...
                return ApiResult.ToErrorModel("خطا در ویرایش دسته بندی", exception: ex);
            }
        }
        ...
        public ApiResult InsertCategory(InsertCategoryDto model)
        {
            ...
            catch (Exception ex)
            {
                ...
                return ApiResult.ToErrorModel("خطا در ثبت دسته بندی", exception: ex);
            }
        }
        ...
        public ApiResult RemoveCategory(int id)
        {
            ...
            catch (Exception ex)
            {
                ...
                return ApiResult.ToErrorModel("خطا در حذف دسته بندی", exception: ex);
            }
        }
    }
}
